...
window.closeLightbox = function(e) {
  const lightbox = document.getElementById('lightbox');
  if (lightbox && (!e || e.target === lightbox || e.target.classList.contains('lightbox-close'))) {
...
window.closeProjectModal = function(e, id) {
  const modal = document.getElementById(id);
  if (modal && (!e || e.target === modal || e.target.classList.contains('project-modal-close'))) {
